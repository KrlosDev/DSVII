...
class UsuariosMDB
{
    ...
    public function insertarRegistro($nombre, $apellido, $email, $edad)
    {
        try {
            ...
            echo "ocurrio la siguiente exepcion al tratar de guardar el registro: ", $e->getMessage(), "\n";
        }
    }
    ...
    public function obtenerRegistros()
    {
        ...
        try {
            ...
            echo "ocurrio la siguiente excepcion al tratar de leer registros: ", $e->getMessage(), "\n";
        }
    }
}
